...
def titulo_atributo(atributo, objeto):
    ...
    try:
        ...
        logger.error("Error: Script de validacion de datos en la Etapa 7 (Acciones de Campo) : titulo_atributo")
        logger.error(e)
try:
    userInfo = mbo.getUserInfo()
    campos=""
    ...
    if not lista.isEmpty():
        ...
        #elif prepTarea.getInt("IMPREVISTOS_AC") == 0:
